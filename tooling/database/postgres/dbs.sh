...
tests=(default_test_pool create_delete_pool walletpooldao walletpool_test databasedaotest account_test account_api_test_pool pool_a pool_b pool_c empty_pool tez_test_pool)
