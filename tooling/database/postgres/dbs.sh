...
tests=(default_test_pool create_delete_pool walletpooldao databasedaotest account_test pool_a pool_b pool_c empty_pool test_pool random POOL_NAME tez_test_pool)
