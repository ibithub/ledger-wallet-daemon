...
case class ERC20AccountNotFound(tokenAddress: String)
  extends {
    val msg = s"No ERC20 account found for $tokenAddress"
    val code = ErrorCodes.ERC20_ACCOUNT_NOT_FOUND
  } with DaemonException(msg)
...
object ErrorCodes {
  ...
  val ERC20_ACCOUNT_NOT_FOUND = 104
