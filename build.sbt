Global / name := "wallet-daemon"
Global / version := "2.8.1-h3"
Global / organization := "co.ledger"
Global / scalaVersion := "2.12.10"
Global / buildInfoPackage := "co.ledger.wallet.daemon"
...
lazy val buildInfoSettings = Seq(
  buildInfoKeys := Seq[BuildInfoKey](Global / name, Global / version, Global / scalaVersion),
  buildInfoKeys ++= Seq[BuildInfoKey]("commitHash" -> git.gitHeadCommit.value),
...
Global / parallelExecution in Test := true
Global / parallelExecution in IntegrationTest := false
...
Global / testOptions in Test := Seq(Tests.Argument(TestFrameworks.JUnit, "-a", "-q"))
